...
import Question12 from "@/assets/question-12.png";
...
const data: Question[] = [
  ...
  },
  {
    id: 6,
    value: "Бонус",
    question: "Какая сипелка самая любимая у Веры Коршуновой?",
    categoryName: "Вожатство",
  ...
  },
  {
    id: 12,
    value: "Бонус",
    question: "Какой любимый возраст детей у Юлии Чирковой?",
    categoryName: "Дети",
  ...
  },
  {
    id: 30,
    value: "Бонус",
    question: "Какое любимое мероприятие в РСО у Артёма Сорокина?",
    categoryName: "Отряды",
    answer: "ДеТали",
    isAnswered: false,
